...
/** Bouton de connexion via Google (OAuth2) — variant outline, pleine largeur. */
export default function GoogleButton({ label = "Continuer avec Google" }: GoogleButtonProps) {
    return (
        <Button type="button" variant="outline" className="w-full gap-2.5" onClick={loginWithGoogle}>
            <GoogleIcon />
            {label}
        </Button>
    );
